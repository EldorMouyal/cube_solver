...
def filter_lines_unusual_thetas(lines,theta):
    ...
    min_theta_possible = find_thetas_possible(theta,thetas,min_bin_index_with_lines,max_bin_index_with_lines)[0]     #minimum theta of all lines
    max_theta_possible = find_thetas_possible(theta,thetas,min_bin_index_with_lines,max_bin_index_with_lines)[1]    #maximum theta of all lines
    lines_filtered=[]
    for line in lines:
        _rho, _theta = line[0]
